...
const SQUARE_TEMPLATES: Record<TemplateKind, TemplateLayout> = {
  ...
  content: {
    ...
    portraitSlot: null,
    titleSlot: { x: 100, y: 220, width: 880, fontSize: 56, align: "left" },
    bodySlot: { x: 100, y: 380, width: 880, fontSize: 32, align: "left" },
    slideNumberSlot: { x: SQUARE_W - 90, y: 980, size: 16, show: true },
  },
  minimal: {
    kind: "minimal",
    format: "square",
    decorativeBlock: { x: 100, y: 540, width: 200, height: 6, paletteIndex: 1, opacity: 1 },
    logoSlot: { x: SQUARE_W / 2 - 70, y: 80, width: 140, height: 140 },
    portraitSlot: null,
    titleSlot: { x: 100, y: 320, width: 880, fontSize: 70, align: "center" },
    bodySlot: { x: 100, y: 600, width: 880, fontSize: 28, align: "center" },
...
const REELS_TEMPLATES: Record<TemplateKind, TemplateLayout> = {
  ...
  minimal: {
    kind: "minimal",
    format: "reels",
    decorativeBlock: { x: 100, y: 920, width: 240, height: 8, paletteIndex: 1, opacity: 1 },
    logoSlot: { x: REELS_W / 2 - 80, y: 120, width: 160, height: 160 },
    portraitSlot: null,
    titleSlot: { x: 100, y: 580, width: 880, fontSize: 90, align: "center" },
    bodySlot: { x: 100, y: 1000, width: 880, fontSize: 34, align: "center" },
