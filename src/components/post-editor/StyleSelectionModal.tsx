...
const StyleSelectionModal: React.FC<StyleSelectionModalProps> = ({
  ...
  const cards: Array<{
  ...
  }> = [
    {
      ...
      preview: (
        <div className={`w-full ${aspect} rounded-md overflow-hidden`} style={{ background: minimalGradient }}>
    ...
    },
    {
      ...
      preview: (
        <div className={`w-full ${aspect} rounded-md overflow-hidden bg-muted relative`}>
          {loadingPreview ? (
    ...
    },
    {
      ...
      preview: (
        <div className={`w-full ${aspect} rounded-md overflow-hidden relative`}
